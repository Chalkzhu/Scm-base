...
const initialState = {
  ...
  instance: { data: [], fullData: [], filterValues: {}, placeholder: '请输入', custom: false, levelGroup: false, search: true, searchKey: 'search', levelGroupKey: 'levGroup', filter: true, complex: true }, // 初始化数据
  visibleFields: [], // 显示的字段
  orderFields: [], // 排序的字段
