...
const Body = () => {
  ...
  const { dispatch, state, tableInstance, size = 'small', stripe, rowConfig } = useContext(Context);
  ...
  return (
    <>
      <div className={cn('ck-body', { 'row-hover': rowConfig.isHover, stripe })} {...getTableBodyProps()}>
