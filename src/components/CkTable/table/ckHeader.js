...
const HeaderCell = ({ column, style, ...reset }) => {
  ...
  return (
    <div className={cn('ck-th', {[`fixed-${column.fixed}`]: !!column.fixed})} style={sty} {...reset}>
      <div className="ck-cell">
        {column.type === 'checkbox' ? <CheckBox {...getToggleAllRowsSelectedProps()} /> : column.render('Header')}
      </div>
...
const headerProps = (props, { column }) => [
  props,
  {
    style: {
      ...
      maxWidth: column.maxWidth < 2000 ? column.maxWidth : null,
    },
  },
];
